...
# ? This mod modifies the mitosis cog attack to copy the original cog's health

const MOD_DIR := "DarthAnonymous-BetterMitosis" # Name of the directory that this file is in
const LOG_NAME := "DarthAnonymous-BetterMitosis:Main" # Full ID of the mod (AuthorName-ModName)
